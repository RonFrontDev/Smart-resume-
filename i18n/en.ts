export const en = {
  ...
  pageTitles: {
      ...
      "content-creation": "Content Creation & Social Media Resume",
  ...
  education: {
    list: [
      { duration: "January 2020 - October 2021", institution: "Roskilde Technical School", location: "Roskilde, Denmark", degree: "Frontend Developer" },
      { duration: "2012 - 2014", institution: "KEA - Design & Business", location: "Copenhagen, Denmark", degree: "Entrepreneurship and design (E-Designer)" },
  ...
  experience: {
      kraftvrk: { role: "Crossfit instructor and social content creator", achievements: { fitness: ["Develop and lead high-energy CrossFit classes, focusing on technique, safety, and performance.", "Create engaging social media content (videos, posts) to build community and promote the gym's brand, increasing online engagement."], professional: ["Execute a content strategy across multiple social media platforms to drive brand awareness and member acquisition.", "Manage content production from concept to publication, including filming and editing."] } },
      ...
      artesuave: { role: "Instructor", achievements: { fitness: ["Coach dynamic CrossFit and Boxing classes for members of all skill levels, from beginners to advanced athletes.", "Contribute to a motivating and supportive gym culture that promotes member consistency and progress."], professional: ["Created and managed social media content to promote gym activities and build community engagement."] } },
      ...
      cf2400: { role: "Crossfit Box Manager", achievements: { fitness: ["Managed daily operations for an 800+ member CrossFit facility, fostering a premier training environment.", "Designed and implemented diverse training programs that increased member skill levels and satisfaction.", "Grew the community by organizing engaging workshops and social events."], professional: ["Directed business aspects, including staff management, financial oversight, and strategic planning, leading to sustained profitability.", "Recruited, trained, and mentored a team of 20 coaches, elevating the quality of instruction and service.", "Handled staff management, finances, and procurement.", "Developed a targeted social media marketing strategy and produced content."] } },
