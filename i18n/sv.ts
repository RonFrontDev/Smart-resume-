export const sv = {
  ...
  education: {
    list: [
        { duration: "Januari 2020 - Oktober 2021", institution: "Roskilde Tekniska Skola", location: "Roskilde, Danmark", degree: "Frontendutvecklare" },
        { duration: "2012 - 2014", institution: "KEA - Design & Business", location: "Köpenhamn, Danmark", degree: "Entrepreneurship and design (E-Designer)" },
  ...
  experience: {
      ...
      artesuave: { role: "Instruktör", achievements: { fitness: ["Coachar dynamiska CrossFit- och boxningsklasser för medlemmar på alla färdighetsnivåer, från nybörjare till avancerade idrottare.", "Bidrar till en motiverande och stödjande gymkultur som främjar medlemmarnas kontinuitet och framsteg."], professional: ["Skapade och hanterade innehåll för sociala medier för att marknadsföra gymmets aktiviteter och bygga gemenskapsengagemang."] } },
